...
Stock.prototype = {
     ...
     * every GameManager.VALUESPERREALSECONDS seconds
     * 
    ...
    nextValue: function () {
        ...
        // Since setInterval doesn't execute already when instantiated the generation is 1 value behind
        let i = GameManager.MAXYEARGAP * 365 / Stock.TIMESTEP + ~~(((GameManager.gameTimer() - GameManager.STARTDATE) / (24 * 60 * 60 * 1000)) / Stock.TIMESTEP) - 1
        ...
        if (mulberry32(this.seed + i ) > this.stability) this.rising *= -1
